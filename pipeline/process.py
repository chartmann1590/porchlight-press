...
def main(argv: list[str] | None = None) -> int:
    ...
    for c in raw_clusters:
        ...
        # Cluster locations: union of member locations (max 3, by frequency).
        ...
        top_keys = [k for k, _ in counted.most_common(3)] or [
            json.dumps({"country": "US"}, sort_keys=True)]
        locations = [by_key[k] for k in top_keys if k in by_key]
        # Section: most specific member section.
        ...
        cluster_view.update({
            ...
            # Schema-compatible lowercase tier (UNVERIFIED -> low; story schema
            # allows only high/medium/low, confidence stays internal anyway).
